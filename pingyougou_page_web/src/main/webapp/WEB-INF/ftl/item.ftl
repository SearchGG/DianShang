...
<body ng-app="pyg" ng-controller="itemPageController" >
<!-- 头部栏位 -->
<!--页面顶部-->
<div id="nav-bottom">
    <!--顶部-->
            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom"><img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="200px" height="200px"/></span>
                    </div>
                    <!--下方的缩略图-->
                       ...
                       <#--商品规格数据-->
                        ...
                        <dl>
                           ...
                           <#-- class="selected"-->
                            ...
                            <dd><a href="javascript:;" ng-click="updataSpecAttribute('${spec.attributeName}','${value}')" class="{{isSelect('${spec.attributeName}','${value}')?'selected':''}}" >${value}<span title="点击取消选择">&nbsp;</span></a></dd>
                          </#list>
                        </dl>
                        </#list>
                    </div>
